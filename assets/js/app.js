...
function dateApp() {
  return {
    ...
    calculateDate() {
      ...
      if (!this.addDate) {
        this.addError = this.t.errEnterDate;
        return;
      }
      if (!this.addDays || this.addDays < 1) {
        this.addError = this.t.errEnterDays;
        return;
      }
    ...
    calculateDuration() {
      ...
      if (!this.startDate) {
        this.countError = this.t.errEnterStartDate;
        return;
      }
      if (!this.endDate) {
        this.countError = this.t.errEnterEndDate;
        return;
      }
